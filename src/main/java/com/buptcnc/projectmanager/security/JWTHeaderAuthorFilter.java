 ...
 */
@Slf4j
public class JWTHeaderAuthorFilter extends BasicAuthenticationFilter {
    public JWTHeaderAuthorFilter(AuthenticationManager authenticationManager) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (tokenHeader == null || !tokenHeader.startsWith(JwtTokenUtil.TOKEN_PREFIX)) {
            log.info("token header auth failed");
