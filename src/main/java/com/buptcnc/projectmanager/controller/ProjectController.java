...
public class ProjectController {
    ...
    public List<Project> getProjects(HttpServletRequest request) {
        String token =  request.getHeader("Authorization")
                .substring(JwtTokenUtil.TOKEN_PREFIX.length());
        ...
        if (prof != null) {
            ...
            projQueryWrapper.eq("prof_id", username);
...
//        }
    ...
    public String insert(@RequestBody Project project) {
        ...
        pqw.eq("cooperation", project.getCooperation())
                .eq("prop", project.getProp())
                .eq("name", project.getName());
        Project tmp = projService.getOne(pqw);
        if (tmp != null) {
...
//                .set("name", project.getName());
    ...
    public String end(@RequestBody Project project) {
